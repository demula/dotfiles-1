...
static const char colors[NUMCOLORS][ColLast][13] = {
    ...
    { "#A7DBD8", "#FFFFFF", "#2D2D2D" },        /* 02 - selected */
...
static const char *term[] = { "st", NULL, "URxvt" };
...
static Key keys[] = {
    ...
    { MODKEY,           XK_w,       runorraise,     {.v = webb } },
    { MODKEY,           XK_s,       runorraise,     {.v = chat } },
    { MODKEY,           XK_Return,  runorraise,     {.v = term } },
    { MODKEY,           XK_e,       runorraise,     {.v = edit } },
    { MODKEY,           XK_m,       runorraise,     {.v = mdia } },
    { MODKEY,           XK_f,       runorraise,     {.v = file } },
